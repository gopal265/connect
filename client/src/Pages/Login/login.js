...
import { login } from '../../Component/ReduxContainer/userApi';
export default function Login() {
  ...
  return (
      ...
      <div className={`center-col outer-login-container`}>
        {error && <div class="alert alert-danger text-center error full-width" role="alert">
          {error}
      </div>}
            ...
            <div className='row'>
              ...
              <div className='col-lg-6 center'>
                <div className='login-form-container'>
                  ...
                  <div className='pt-4'>
                    <button className='login-button btn btn-info full-width' onClick={handleClick}>{loading === true ? "Loading...." : "Login"}</button>
                  </div>
